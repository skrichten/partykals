...
export default class ParticlesSystem {
     ...
     * @param {Object3D} options.container Container to add particles system to.
     *
     * // PARTICLES OPTIONS
     * ============================================================================
     ...
     *
     * // PARTICLES COLORING
     * @param {Color} options.particles.color Per-particle constant color; either a constant value (Color) or a Partykals.Randomizers.Randomizer instance to create random values.
     * @param {Color} options.particles.startColor Starting color min value; either a constant value (Color) or a Partykals.Randomizers.Randomizer instance to create random values.
     * @param {Color} options.particles.endColor Ending color min value; either a constant value (Color) or a Partykals.Randomizers.Randomizer instance to create random values.
     ...
     * @param {Vector3} options.particles.acceleration Particles acceleration; either a constant value (Vector3) or a Partykals.Randomizers.Randomizer instance to create random values.
     ...
     *
     * // PARTICLES VELOCITY
     * @param {*} options.particles.velocity Particles starting velocity; either a constant value (Vector3) or a Partykals.Randomizers.Randomizer instance to create random values.
     * @param {Vector3} options.particles.velocityBonus Velocity value to add to all particles after randomizing velocity.
     *
     * // PARTICLES OFFSET
     * @param {Vector3} options.particles.offset Particles offset from system's center; either a constant value (Vector3) or a Partykals.Randomizers.Randomizer instance to create random values.
     *
     * // PARTICLE GLOBALS
     ...
     * @param {Texture} options.particles.texture Particle's texture to use.
     *
     * // CUSTOM CALLBACKS
    ...
    constructor(options) {
        ...
        if (options.particles.color instanceof Color) {
        ...
        this.particlesGeometry.setAttribute( 'position', new BufferAttribute( vertices, 3 ) );
        if (alphas) { this.particlesGeometry.setAttribute( 'alpha', new BufferAttribute( alphas, 1 ) ); }
        if (colors) { this.particlesGeometry.setAttribute( 'color', new BufferAttribute( colors, 3 ) ); }
        if (sizes) { this.particlesGeometry.setAttribute( 'size', new BufferAttribute( sizes, 1 ) ); }
        if (rotations) { this.particlesGeometry.setAttribute( 'rotation', new BufferAttribute( rotations, 1 ) ); }
     ...
     * @param {Object3D} container Container to add system to.
     */
    addTo(container)
    {
